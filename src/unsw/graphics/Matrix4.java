...
public class Matrix4 {
     ...
     * @param phi
     */
    public Matrix4(Vector3 i, Vector3 j, Vector3 k, Point3D phi) {
        values = new float[16];
        System.arraycopy(i.extend().getValues(), 0, values, 0, 4);
        System.arraycopy(j.extend().getValues(), 0, values, 4, 4);
        System.arraycopy(k.extend().getValues(), 0, values, 8, 4);
        System.arraycopy(phi.asHomogenous().getValues(), 0, values, 12, 4);
    }
